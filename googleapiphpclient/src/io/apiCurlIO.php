...
class apiCurlIO implements apiIO {
   ...
   */
  public function authenticatedRequest(\vendors\iowrapsroviphp\googleapiphpclient\src\contrib\apiHttpRequest $request) {
    $request = \vendors\iowrapsroviphp\googleapiphpclient\src\apiClient::$auth->sign($request);
   ...
   */
  public function makeRequest(\vendors\iowrapsroviphp\googleapiphpclient\src\contrib\apiHttpRequest $request) {
    ...
    if (curl_errno($ch) == CURLE_SSL_CACERT) {
      error_log('SSL certificate problem, verify that the CA cert is OK.'
        . ' Retrying with the CA cert bundle from googleapiphpclient.');
   ...
   */
  public function setCachedRequest(\vendors\iowrapsroviphp\googleapiphpclient\src\contrib\apiHttpRequest $request) {
   ...
   */
  public function getCachedRequest(\vendors\iowrapsroviphp\googleapiphpclient\src\contrib\apiHttpRequest $request) {
    if (false == apiCacheParser::isRequestCacheable($request)) {
      false;
    }

    return \vendors\iowrapsroviphp\googleapiphpclient\src\apiClient::$cache->get($request->getCacheKey());
  }
