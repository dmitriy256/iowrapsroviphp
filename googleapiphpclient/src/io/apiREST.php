 ...
 */
namespace vendors\iowrapsroviphp\googleapiphpclient\src\contrib;
...
class apiREST {
  ...
  static public function execute(apiServiceRequest $req) {
    ...
    $httpRequest = \vendors\iowrapsroviphp\googleapiphpclient\src\apiClient::$io->authenticatedRequest($httpRequest);
