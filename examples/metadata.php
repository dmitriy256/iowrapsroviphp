 ...
 * @license  https://raw.github.com/mashery/iowrapsroviphp/master/LICENSE.txt MIT License
 * @version  GIT: $Id:$
 * @link     https://github.com/mashery/iowrapsroviphp/
 * 
 */

// Client library (network/authentication)
require_once "../googleapiphpclient/src/apiClient.php";

// Rovi resource/method library
require_once "../googleapiphpclient/src/contrib/apiMetadataandsearchapiService.php";
